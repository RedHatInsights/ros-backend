from .v1.hosts import HostsApi, HostDetailsApi, HostHistoryApi, IsROSConfiguredApi, ExecutiveReportAPI
...
def initialize_routes(api):
    ...
    api.add_resource(ExecutiveReportAPI, '/api/ros/v1/systems/executive-report')
