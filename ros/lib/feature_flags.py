...
def get_flag_value(flag_name: str) -> bool:
    # As of now ros does not care if unleash is set by fallback or unleash service
    # however in future we may need to know if its from fallback or service
    # considering this only returning the flag_value
